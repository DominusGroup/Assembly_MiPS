...
%endmacro
 ...
 %macro WritetxtX 2  ;ACTULIZAR LENGTH
;------- open file for writing
;	mov rax, 	  		SYS_OPEN		            
;	mov rdi, 	  		OUTPUT_FILE_NAME
...
;-------------------  Memory Data -------------------------
  ...
  model:         equ $regout_aux3
  family:         equ $regout_aux4
...
_pantallafinal:
    ...
    mov rax, 1
	mov rdi, 1
	mov rsi, pantalla_final_1
	mov rdx, l7_tamano
	syscall

	mov rax, 1
	mov rdi, 1
	mov rsi, pantalla_final_2
	mov rdx, l8_tamano
	syscall

    mov rax, 1
	mov rdi, 1
	mov rsi, pantalla_final_3
	mov rdx, l9_tamano
	syscall

    mov rax, 1
	mov rdi, 1
	mov rsi, pantalla_final_4
	mov rdx, l10_tamano
	syscall

    mov rax, 1
	mov rdi, 1
	mov rsi, pantalla_final_5
	mov rdx, l11_tamano
	syscall

    mov rax, 1
	mov rdi, 1
	mov rsi, pantalla_final_6
	mov rdx, l12_tamano
	syscall
